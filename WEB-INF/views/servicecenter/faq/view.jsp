			...
			<div class="row">
				...
				<div class="col-12 col-lg-3">
					<div class="contact-content mb-100">
						...
						<div class="single-contact-info d-flex align-items-center">
							...
							<p>
								<a
									href="<%=request.getContextPath() %>/servicecenter/notice/notice">공지사항</a>
							</p>
						</div>
				...
				<div class="col-12 col-lg-9">
					<table class="table table-striped"
						...
						<p class="pFont">UID : ${list[0].f_uid }</p>
						...
						<button onclick="location.href='update?uid=${list[0].f_uid}'" class="faqbtn">수정하기</button>
						<button onclick="location.href = 'faq'" class="faqbtn">목록보기</button>
						<button onclick="chkDelete(${list[0].f_uid})" class="faqbtn">삭제하기</button>
						<button onclick="location.href = 'write'" class="faqbtn">신규등록</button>
					</table>
				</div>
			</div>
		</div>
...
<hr>
<br>
<button onclick="location.href='update?uid=${list[0].f_uid}'">수정하기</button>
<button onclick="location.href = 'faq'">목록보기</button>
<button onclick="chkDelete(${list[0].f_uid})">삭제하기</button>
